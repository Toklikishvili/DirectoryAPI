...
{
    /// <inheritdoc />
    public partial class DirecortyMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelatedPersons", x => new { x.PersonId, x.RelationPersonId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RelatedPersons_Persons_RelationPersonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelatedPersons_RelationPersonId",
